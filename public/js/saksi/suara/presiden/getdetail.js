$(document).ready(function()
{
  ...
  $.ajax({
    ...
    success: function(html)
    {
      ...
      {
        var res = "";
        res = '<div class="col-md-12 pl-1"><div class="form-group"><label>'+val.partai+'</label><input type="number" name="suarapartai['+val.id+']" class="form-control" value="0"><b>Suara partai harus diisi 0!</b></div></div>';
        $("#"+val.id).html(res);
          $.ajax({
