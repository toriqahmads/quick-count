      ...
      $.each(html, function(key, val)
      {
          $.ajax({
              ...
              success: function(data){
                  var res = "";
                  res = '<div class="col-md-12 pl-1"><div class="form-group"><label>'+data[0]['partai']+'</label><input type="number" name="suarapartai['+data[0]['id_partai']+']" class="form-control" value="0"><b>Suara partai harus diisi 0!</b></div></div>';
