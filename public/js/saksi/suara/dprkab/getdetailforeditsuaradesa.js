$(document).ready(function()
{
  ...
  $.ajax({
    ...
    success: function(html){
      ...
      {
          $.ajax({
              url: window.location.origin+"/suara/desa/suarapartaibysaksi/"+val.id+"/"+id_kel+"/"+id_saksi+"/"+tingkat,
              type: "GET",
              success: function(data){
                  ...
                  $.ajax({
                      url: window.location.origin+"/suara/desa/suaracalegbysaksi/"+val.id+"/"+id_kel+"/"+id_saksi+"/"+tingkat,
                      type: "GET",
