$(document).ready(function()
{
  ...
  $("#kab").on('change', function()
  {
      ...
      else
      {
          tingkat = $("#tingkat").val();
          $.ajax({
            url: window.location.origin+"/tabulasi/desa/partai/kab/"+kab+"/"+tingkat,
            type: "GET",
            success: function(datas){
              ...
              var id_partais = JSON.stringify(id_partai);
                $.ajax({
                  url: window.location.origin+"/tabulasi/desa/caleg/kab/"+id_partais+"/"+kab+"/"+tingkat,
                  type: "GET",
                  success: function(data){
                    var datachart = [];
                      ...
                      chart("Jumlah Suara Partai DPR Prov By Kabupaten", datachart);
