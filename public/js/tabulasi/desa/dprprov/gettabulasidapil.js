$(document).ready(function()
{
  ...
  $("#dapil").on('change', function()
  {
      ...
      else
      {
          tingkat = $("#tingkat").val();
          $.ajax({
            url: window.location.origin+"/tabulasi/desa/partai/dapil/"+dapil+"/"+tingkat,
            type: "GET",
            success: function(datas){
              ...
              var id_partais = JSON.stringify(id_partai);
                $.ajax({
                  url: window.location.origin+"/tabulasi/desa/caleg/dapil/"+id_partais+"/"+dapil+"/"+tingkat,
                  type: "GET",
                  success: function(data){
                    var datachart = [];
                      ...
                      chart("Jumlah Suara Partai DPR Prov By Dapil", datachart);
