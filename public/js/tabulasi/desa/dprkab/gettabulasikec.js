$(document).ready(function()
{
  ...
  $("#kec").on('change', function()
  {
      ...
      else
      {
        tingkat = $("#tingkat").val();
        $.ajax({
          url: window.location.origin+"/tabulasi/desa/partai/kec/"+kec_id+"/"+tingkat,
          type: "GET",
          success: function(datas){
            ...
            var id_partais = JSON.stringify(id_partai);
              $.ajax({
                url: window.location.origin+"/tabulasi/desa/caleg/kec/"+id_partais+"/"+kec_id+"/"+tingkat,
                type: "GET",
                success: function(data){
                    ...
                    chart("Jumlah Suara Partai DPR Kabupaten By Kecamatan", datachart);
