$(document).ready(function()
{
  ...
  $("#kel").on('change', function()
  {
      ...
      else
      {
        tingkat = $("#tingkat").val();
        $.ajax({
          url: window.location.origin+"/tabulasi/desa/partai/kel/"+kel_id+"/"+tingkat,
          type: "GET",
          success: function(datas){
            ...
            var id_partais = JSON.stringify(id_partai);
              $.ajax({
                url: window.location.origin+"/tabulasi/desa/caleg/kel/"+id_partais+"/"+kel_id+"/"+tingkat,
                type: "GET",
                success: function(data){
                    ...
                    chart("Jumlah Suara Partai DPR Kabupaten By Kelurahan", datachart);
