...
<script src="{{ asset('js/saksi/suara/dprri/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dprri/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dprri/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dprri/delete-suara.js')}}" type="text/javascript"></script>
