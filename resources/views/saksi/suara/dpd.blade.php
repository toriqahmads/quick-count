...
<script src="{{ asset('js/saksi/suara/dpd/getdetail.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('js/saksi/suara/dpd/kirim-suara.js')}}" type="text/javascript"></script>
@endsection