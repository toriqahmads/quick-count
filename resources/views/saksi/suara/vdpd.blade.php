...
<script src="{{ asset('js/saksi/suara/dpd/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dpd/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dpd/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dpd/delete-suara.js')}}" type="text/javascript"></script>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="row">
        ...
        <input type="hidden" id="dapil" name="dapil" value="{{Session::get('dapil_prov')}}">
