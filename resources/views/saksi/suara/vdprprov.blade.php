...
<script src="{{ asset('js/saksi/suara/dprprov/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dprprov/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dprprov/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/saksi/suara/dprprov/delete-suara.js')}}" type="text/javascript"></script>
