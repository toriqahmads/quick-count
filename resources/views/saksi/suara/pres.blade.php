...
<script src="{{ asset('js/saksi/suara/pres/getdetail.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('js/saksi/suara/dprkab/kirim-suara.js')}}" type="text/javascript"></script>
@endsection