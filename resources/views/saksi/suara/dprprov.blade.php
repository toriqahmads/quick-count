...
<script src="{{ asset('js/saksi/suara/dprprov/getdetail.js')}}" type="text/javascript"></script>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
        <div class="row">
          <h3>Input Suara DPR Provinsi</h3>
        </div>
      <div class="row">
...
<script src="{{ asset('js/saksi/suara/dprprov/kirim-suara.js')}}" type="text/javascript"></script>
@endsection