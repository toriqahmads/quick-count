  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
        <div class="row">
          <h3>Tabulasi Suara DPR Provinsi By Kecamatan</h3>
        </div>
      <div class="row">
   ...
   <div class="col-md-3">
      <div class="card">
        ...
        <div class="card-body">
          <form id="suara{{$part->id}}" class="form" method="post" action="" enctype="multipart/form-data">
            {{ csrf_field() }}
...
<script src="{{ asset('js/tabulasi/desa/dprprov/gettabulasikec.js')}}" type="text/javascript"></script>
