  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
        <div class="row">
          <h3>Tabulasi Suara DPR Provinsi By Tps</h3>
        </div>
      <div class="row">
...
<script src="{{ asset('js/tabulasi/dprprov/gettabulasitps.js')}}" type="text/javascript"></script>
