...
<script src="{{ asset('js/suara/dprri/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprri/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprri/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprri/delete-suara.js')}}" type="text/javascript"></script>
