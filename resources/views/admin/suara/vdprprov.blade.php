...
<script src="{{ asset('js/suara/dprprov/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprprov/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprprov/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprprov/delete-suara.js')}}" type="text/javascript"></script>
