...
<script src="{{ asset('js/suara/pres/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/pres/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/pres/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/pres/delete-suara.js')}}" type="text/javascript"></script>
