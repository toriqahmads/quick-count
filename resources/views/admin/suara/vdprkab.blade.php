...
<script src="{{ asset('js/suara/dprkab/getdetailforeditsuara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprkab/edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprkab/kirim-edit-suara.js')}}" type="text/javascript"></script>
<script src="{{ asset('js/suara/dprkab/delete-suara.js')}}" type="text/javascript"></script>
